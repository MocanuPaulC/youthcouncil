...
VALUES ('gadmin@localhost', 'gadmin', 'gadmin', '$2a$10$p3Q7uAuj6J.wM15xVL/QAeVOtLEy0HShtsqSRILTlOOVrxtLe50d6',
       ...
       ( 'moderator@localhost', 'moderator', 'moderator', '$2a$10$NL4iJdBptEYYDnsYvKaIW.7kPQNmi2ZQD9WZQ81VD2ETmpRVULrfS',
...
INSERT INTO youthcouncil_council_admins VALUES(1, 2);
INSERT INTO youthcouncil_council_members VALUES(1, 4);

-- INFORMATIVE PAGES
INSERT INTO informative_pages (is_enabled, title)
VALUES ( 'true', 'my_informative_page' );
INSERT INTO youthcouncil_informative_pages VALUES ( 1, 1 );


-- ACTION POINTS
INSERT INTO module_items(module_item_type, description, is_default, is_enabled, title, label, image)
VALUES ( 'actionpoint', 'my action point description', 'false', 'true', 'my_action_point', 'NEW', 'my/action/point/image ' );
INSERT INTO youthcouncil_module_items VALUES ( 1, 1);

-- CALL FOR IDEA
INSERT INTO module_items(module_item_type, description, is_default, is_enabled, title, image)
VALUES ( 'call-for-idea', 'my call for idea description', 'false', 'true', 'my_call_for_idea', 'my/call/for/idea/image ' );
INSERT INTO youthcouncil_module_items VALUES ( 1, 2);

-- NEWSFEED
INSERT INTO module_items(module_item_type, description, is_default, is_enabled, title, image)
VALUES ( 'announcement', 'my announcement description', 'false', 'true', 'my_announcement', 'my/announcement/image ' );
INSERT INTO youthcouncil_module_items VALUES ( 1, 3);
...
VALUES
    ('safety at intersection x'),
    ('safety in area y');

INSERT INTO themes_sub_themes VALUES (1, 1);